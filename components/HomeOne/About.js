        ...
        return (
            <section id="about" className="app-about-section ">
                <div className="container">
                            ...
                            >
                                <div className="section-title">
                                    ...
                                    <p>
                                        ...
                                        clientes y garantizar la seguridad y salud en el
                                        trabajo para nuestros colaboradores. Asi mismo, fomentamos una cultura de
                                        prevención de riesgos laborales,
                                        identificando y eliminando incidentes
                    ...
                    <div className="row align-items-center mt-4 bg-green">
                        <div className="col-lg-5">
                            <ScrollAnimation
                                animateIn="fadeInUp"
                                delay={150}
                            ...
                            >
                                <div className="app-about-text mt-4">
                                    ...
                                    <p>
                                        ...
                                        calidad y servicio, contribuyendo al
